...
namespace UbStudyHelp.Classes
{
    ...
    /// 
    /// </summary>
    public class LuceneEditBookSearch
    {
        ...
        public LuceneEditBookSearch(string basePathForFiles, Translation translation)
        {
        ...
        private bool CreateUBIndex()
        {
            ...
            catch (Exception ex)
            {
                ...
                StaticObjects.FireShowExceptionMessage("Creating Book Search Data for ", ex);
                return false;
            }
        }
        ...
        public bool Execute(SearchData searchData)
        {
            try
            {
                if (!CreateUBIndex())
                {
                    ...
                    StaticObjects.FireSendMessage("Book Index not created.");
                }
            ...
            catch (Exception ex)
            {
                ...
                StaticObjects.FireShowExceptionMessage("Executing Search", ex);
                return false;
            }
        }
